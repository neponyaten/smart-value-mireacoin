...
export const usersSeed: InternalUser[] = [
  {
    ...
    bio: "Люблю оптимизировать дедлайны так же, как и портфель монет.",
    group: "ИКБО-01-23",
    role: "STUDENT",
    balance: 540,
    coins: 540,
    ...
    showVk: false,
    showMax: false,
    telegramUrl: "https://t.me/ivan_mirea",
    vkUrl: "",
    maxUrl: "",
  ...
  },
  {
    ...
    bio: "Собираю сильную команду и держу топ по балансу группы.",
    group: "ИКБО-01-23",
    role: "LEADER",
    balance: 1260,
    coins: 1260,
    ...
    showVk: true,
    showMax: true,
    telegramUrl: "https://t.me/maria_mirea",
    vkUrl: "https://vk.com/maria.mirea",
    maxUrl: "https://max.ru/maria",
    ...
    lastSeenAt: new Date(Date.now() - 1000 * 60 * 6).toISOString(),
    password: "123456",
  },
  {
    id: "u-student-2",
    ...
    bio: "Коллекционер редких эффектов и фанат автоматизации.",
    group: "ИКБО-02-23",
    role: "STUDENT",
    balance: 870,
    coins: 870,
    ...
    showVk: false,
    showMax: false,
    telegramUrl: "https://t.me/alex_mirea",
    vkUrl: "https://vk.com/alex.mirea",
    maxUrl: "",
    ...
    providerMode: "LKS",
    lastSeenAt: new Date(Date.now() - 1000 * 60 * 16).toISOString(),
    password: "123456",
  },
];
